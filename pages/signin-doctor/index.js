...
const DoctorLogin = () => {
    ...
    const onSubmit = async (values) => {
        setLoading(true);
        let respond = await postRequest(apiPaths.DOCTOR_SIGNIN,values);
        if(respond.status){
            ...
            <div className="flex flex-column align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
                <div className="surface-card p-4 shadow-2 border-round w-full lg:w-4">
                    <div className="text-center mb-5">
                        ...
                        <div className="text-900 text-3xl font-medium mb-3">Doctor Signin</div>
                        <span className="text-600 font-medium line-height-3">Don't have an account?</span>
                        <a href="/signup-doctor" className="font-medium no-underline ml-2 text-blue-500 cursor-pointer"> Create today!</a>
                    </div>
                    ...
                    <div>
                            ...
                            {({
                                ...
                                <form noValidate onSubmit={handleSubmit}>
                                    ...
                                    <div className="flex align-items-center justify-content-end mb-6">
                                        <a href="/doctor/forgot-password" className="font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer">Forgot your password?</a>
                                    </div>
                        ...
                        <div className="flex align-items-center justify-content-center mt-2">
                            <a href="/" className="font-medium no-underline text-blue-500 cursor-pointer">Signin as a patient</a>
                        </div>
                    </div>
                </div>
            </div>
...
DoctorLogin.getLayout = function getLayout(page) {
    return (
        <React.Fragment>
            {page}
        </React.Fragment>
